#!/usr/bin/env bash
#SBATCH --job-name=gen_instruct_neutral
#SBATCH -o ./gen_audio_emotion_diff_reference/log/gen_instruct_neutral.log
#SBATCH --gres=gpu:1
...
TEST_JSONL="${DATA_DIR}/test_jsonl/test.neutral.jsonl"
...
output_audio=gen_audio_emotion_diff_reference/data/gen_instruct_neutral
output_dir=gen_audio_emotion_diff_reference/data/gen_instruct_neutral_metadata
